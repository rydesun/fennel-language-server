...
pub(crate) fn first_set(syntax: &SyntaxKind) -> Option<Vec<SyntaxKind>> {
    match syntax {
        ...
        N_L_SYMBOL => Some(vec![SYMBOL]),
        N_R_SYMBOL => Some(vec![SYMBOL]),
        N_L_R_SYMBOL => Some(vec![SYMBOL]),
        N_L_OR_R_SYMBOL => Some(vec![SYMBOL]),
        N_KEY => Some(vec![
            SYMBOL, VARARG, FLOAT, INTEGER, QUOTE_STRING,
            COLON_STRING, BOOL, NIL, L_BRACKET, L_BRACE, L_PAREN,
            BACKTICK, COMMA, HASHFN,
        ]),
        ...
        N_CALL_FN => Some(vec![
            SYMBOL, L_PAREN, BACKTICK, COMMA, HASHFN,
        ]),
        ...
        N_ASSIGN_PATTERN => Some(vec![SYMBOL, L_BRACKET, L_BRACE, CAPTURE]),
        N_SET_PATTERN => Some(vec![SYMBOL, L_BRACKET, L_BRACE, CAPTURE]),
        ...
        N_ASSIGN_PATTERN_KEY => Some(vec![SYMBOL, L_PAREN,
            FLOAT, INTEGER, QUOTE_STRING, COLON_STRING, BOOL, NIL,
            CAPTURE,
        ]),
        N_SET_PATTERN_KEY => Some(vec![SYMBOL, L_PAREN,
            FLOAT, INTEGER, QUOTE_STRING, COLON_STRING, BOOL, NIL,
            CAPTURE,
        ]),
        ...
        N_MATCH_PATTERN_TOP => Some(vec![
            FLOAT, INTEGER, QUOTE_STRING, COLON_STRING, BOOL, NIL,
            SYMBOL, L_BRACKET, L_BRACE, L_PAREN,
        ]),
        N_MATCH_PATTERN => Some(vec![
            FLOAT, INTEGER, QUOTE_STRING, COLON_STRING, BOOL, NIL,
            SYMBOL, L_BRACKET, L_BRACE, CAPTURE,
        ]),
        ...
        N_IMPORT_MACROS_DESTRUCT => Some(vec![L_BRACE, SYMBOL]),
        _ => Some(vec![*syntax]),
    }
}
